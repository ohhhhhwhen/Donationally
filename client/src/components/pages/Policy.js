...
class Policy extends Component {
    ...
    render() {
        return (
            <div className="container" style={{ padding: "100px", textAlign: "left" }}>
                            ...
                            <span style={{ color: "rgb(127, 127, 127)" }}>
                                <strong>
                                    <span data-custom-class="subtitle">
                                        Last updated <bdt className="question">May 30, 2020</bdt>
                                    </span>
                                </strong>
                            </span>
                        </p>
                        ...
                        <p style={{ fontSize: 15 }}>
                            <span style={{ color: "rgb(89, 89, 89)" }}>
                                <span data-custom-class="body_text">
                                    ...
                                    <bdt className="question">Donationally</bdt>
                                    <bdt className="block-component" /> (“
          <bdt className="block-component" />
          ...
          contact us at <bdt className="question">donationally@gmail.com</bdt>.
        </span>
                            </span>
                        </p>
                        <p style={{ fontSize: 15 }}>
          ...
          website{" "}
                                    <bdt className="question">
                                        <a
                                            href="https://donationally.com"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            data-custom-class="link"
                                        >
                                            https://donationally.com
            </a>
                                    </bdt>
          ,<bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" /> and use our services, you trust us
          ...
          when <bdt className="block-component" />
          registering at the <bdt className="block-component" />
          Services
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" />
                                    <bdt className="statement-end-if-in-editor" /> expressing an interest
          in obtaining information about us or our products and services, when
          participating in activities on the <bdt className="block-component" />
          Services
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" />
          ...
          your interactions with us and the <bdt className="block-component" />
          Services
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" />, the choices you make and the
                        ...
                        <p style={{ fontSize: 15 }}>
                            <span style={{ color: "rgb(89, 89, 89)" }}>
                                ...
                                <span data-custom-class="body_text">
                                    ...
                                    <bdt className="forloop-component" />
                                    <bdt className="question">business email</bdt>;{" "}
                                    <bdt className="forloop-component" />
                                    <bdt className="question">social media</bdt>;{" "}
                                    <bdt className="forloop-component" />
                                    <bdt className="question">
          ...
          &nbsp;
            ...
            purposes described below. We process your personal information for
            ...
            <bdt className="block-component" />
              ...
              of the contract. <bdt className="block-component" />
                                        </span>
                                    </span>
                                </span>
                                <span style={{ fontSize: 15 }}>
              ...
              <bdt className="statement-end-if-in-editor" />
                                            <bdt className="block-component" />
                                            <bdt className="block-component" /> that may contain personal
              ...
              or delete your testimonial, please contact us at{" "}
                                            <bdt className="block-component" />
                                            <bdt className="question">donationally@gmail.com</bdt>
              ...
              <bdt className="statement-end-if-in-editor" />
                                            <bdt className="block-component" />
                                            <bdt className="block-component" /> safe and secure (for example,
          ...
          &nbsp;
            ...
            we are involved.
              ...
              technology on the <bdt className="block-component" />
              Services
              <bdt className="statement-end-if-in-editor" />
                                            <bdt className="block-component" />
                                            <bdt className="block-component" />, which will enable them to
              collect data about how you interact with the{" "}
                                            <bdt className="block-component" />
              Services
              <bdt className="statement-end-if-in-editor" />
                                            <bdt className="block-component" />
                                            <bdt className="block-component" /> over time. This information
              ...
              online activity. Unless described in this Policy, we do not share,
              sell, rent or trade any of your information with third parties for
              their promotional purposes. <bdt className="block-component" />
                                        </span>
                                    </span>
                                </span>
                                <span style={{ fontSize: 15 }}>
              ...
              <bdt className="statement-end-if-in-editor" />
                                            <bdt className="block-component" />
                                            <bdt className="block-component" />. These companies may use
              information about your visits to our Website(s) and other websites
              that are contained in web cookies and other tracking technologies
          ...
          <bdt className="block-component" />.
                        ...
                        <p id="googlemaps" style={{ fontSize: 15 }}>
                            <span style={{ color: "rgb(0, 0, 0)" }}>
                                <strong>
                                    <span style={{ fontSize: 19 }}>
                                        <span data-custom-class="heading_1">5. DO WE USE GOOGLE MAPS?</span>
                                    </span>
                                </strong>
                            </span>
                        </p>
          ...
          &nbsp;
                            ...
                            <span style={{ fontSize: 15 }}>
                                <span style={{ color: "rgb(89, 89, 89)" }}>
                                    <span data-custom-class="body_text">
                                        ...
                                        Google Maps APIs. You may find the Google Maps APIs Terms of
                                        Service&nbsp;
          </span>
                                </span>
                                <span data-custom-class="body_text">
                                    ...
                                    <span style={{ color: "rgb(89, 89, 89)" }}>
                                        . To better understand Google’s Privacy Policy, please refer to
                                        this&nbsp;
          </span>
                                    <span style={{ color: "rgb(48, 48, 241)" }}>
                                        <a
            ...
            Google’s Terms of Service. <bdt className="block-component" />{" "}
                                        <bdt className="block-component" />
                                        <bdt className="block-component" />
            We use information about location in conjunction with data from
          ...
          &nbsp;
            ...
            this policy will require us keeping your personal information for
          ...
          information to and from our <bdt className="block-component" />
          Services
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" /> is at your own risk. You should
          ...
          years of age. By using the <bdt className="block-component" />
          Services
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" />, you represent that you are at
          ...
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" />. If we learn that personal
          ...
          at <bdt className="block-component" />
                                    <bdt className="question">donationally@gmail.com</bdt>
                                    <bdt className="else-block" />.
        </span>
                                <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
        ...
        &nbsp;
            ...
            email us at <bdt className="question">donationally@gmail.com</bdt>.
          </span>
                                    <bdt className="statement-end-if-in-editor" />
                                </span>
                            </span>
                        ...
                        <div>
                            <span style={{ fontSize: 16 }}>
                                <span style={{ color: "rgb(0, 0, 0)" }}>
                                    <strong>
                                        <span data-custom-class="heading_2">Account Information</span>
                                    </strong>
                                </span>
                            </span>
                        </div>
      ...
      <span style={{ fontSize: 15 }}>
        ...
        <span style={{ fontSize: 15 }}>
          ...
          registered account with the <bdt className="block-component" />
          Services
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" />, you have the right to request
          removal of unwanted data that you publicly post on the{" "}
                                    <bdt className="block-component" />
          Services
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" />. To request removal of such data,
          ...
          publicly displayed on the <bdt className="block-component" />
          Services
          <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" />
                                    <bdt className="block-component" />, but please be aware that the data
          ...
          email us at <bdt className="question">donationally@gmail.com</bdt>
                        ...
                        <div>
                            <span style={{ color: "rgb(89, 89, 89)" }}>
                                <bdt className="question">
                                    <span style={{ fontSize: 15 }}>
                                        <span data-custom-class="body_text">Donationally</span>
                                    </span>
          &nbsp;
        </bdt>
                                <span data-custom-class="body_text">
                        ...
                        <div>
                            <span data-custom-class="body_text">
                                <span style={{ color: "rgb(89, 89, 89)" }}>
                                    <span style={{ fontSize: 15 }}>
                                        <bdt className="question">Seattle</bdt>
                                        <bdt className="block-component" />
                                        <bdt className="block-component" />,{" "}
                                        <bdt className="question">WA.</bdt>
                                        <bdt className="statement-end-if-in-editor" />
                                        <bdt className="block-component" />
                                        <bdt className="block-component" />{" "}
                                        <bdt className="question">98101</bdt>
                                        <bdt className="statement-end-if-in-editor" />
                                    </span>
                                </span>
                            </span>
        ...
        <span data-custom-class="body_text">
          ...
          <span data-custom-class="body_text">
                                        ...
                                        <span style={{ color: "rgb(48, 48, 241)" }}>
                                            <span data-custom-class="body_text">
                                                <span style={{ fontSize: 15 }}>
                                                    <a
                                                        data-custom-class="link"
                                                        href="https://app.termly.io/notify/bd36bbbd-21ab-439f-b446-3d877b47c159"
                                                        rel="noopener noreferrer"
                                                        target="_blank"
                                                    >
                                                        here
                                ...
                                <bdt className="block-component" />. We will respond to your request
        within 30 days.
      </span>
                        </div>
                        <style
