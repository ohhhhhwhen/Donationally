    ...
    render() {
      ...
      const mainContent = this.state.authenticated ? (
        <div>
          ...
          <div>
            <p className="lead">
              To create a new User Account please <a href="https://dev-240113.okta.com/signin/register" target="_blank" rel="noopener noreferrer"> click here! (Create new account) </a>
            </p>
