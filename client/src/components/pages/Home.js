    ...
    <div>
        ...
        <div className="page_inner_div">
          ...
          <div className="row" style={{ paddingTop: "30px" }}>
            ...
            <div className="row">
              <div className="col-md-6" style={{ padding: "20px 0 20px 0" }} >
                <img src={Boy} alt="" fluid="true" style={{ border: "10px solid white", width: "75%", height: "auto" }} className="only" />
              </div>
              <div className="col-md-6" style={{ paddingBottom: "20px", paddingTop: "20px" }}>
                <section>
                  <img src={Girl} alt="" fluid="true" style={{ border: "10px solid white", width: "65%", height: "auto" }} className="only" />
                  <br></br>
                </section>
                <section style={{ paddingTop: "30px" }}>
                  <img src={Kids2} alt="" fluid="true" style={{ border: "10px solid white", width: "65%", height: "auto" }} className="only" />
                </section>
              </div>
            </div>
          ...
          <div className="row" style={{ paddingTop: "50px" }}>
            ...
            <div className="col-md-6" data-aos="zoom-in" data-aos-delay="100" style={{ padding: "0 90px 0 90px" }}>
              ...
              <p id="responsive_h7" style={{ color: "white" }} >We believe the ability of people to strive for better lives, and we help provide them wth the means to achieve their dreams.</p>
            </div>
            <div className="col-md-6" data-aos="zoom-in" data-aos-delay="100" style={{ padding: "0 90px 0 90px" }}>
      ...
      <div className="normal" data-aos="fade-up" style={{ backgroundColor: "#81d4fa", paddingTop: "100px", paddingBottom: "100px" }}>
        ...
        <div className="page_inner_div">
          ...
          <p id="responsive_h7" style={{ fontSize: "20px", color: "white", marginBottom: "0px", paddingBottom: "20px" }}>Search for a charity and donate.</p>
          <Button variant="outline-secondary" href="/Search">Donate</Button>{' '}
